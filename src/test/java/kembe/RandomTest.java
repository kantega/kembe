...
public class RandomTest {
    ...
    Property prop1 = Property.property( Arbitrary.arbLong, aLong -> Property.prop( new Random( aLong ).nextInt() == new Random( aLong ).nextInt() ) );

    @Name("Same seed will always generate same next value sequence for a standard java Random")
    Property prop2 = Property.property( Arbitrary.arbLong, aLong -> {
