...
public abstract class OccurenceProbability {
    ...
    public static OccurenceProbability inRange(LocalTime from,LocalTime to, Probability p){
        return new LocalTimeRangeOP( from,to,p );
    }

    public abstract Probability occurenceWithin(Interval interval);

    static class LocalTimeRangeOP extends OccurenceProbability {
